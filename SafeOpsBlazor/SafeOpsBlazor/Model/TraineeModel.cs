...
namespace SafeOpsBlazor.Model
{
    ...
    {
        [Required]
        [StringLength(50, ErrorMessage = "Academy id is too long.")]
        [RegularExpression(@"^[0-9]*$", ErrorMessage = "Academy id must be numeric.")]
        public int AcademyId { get; set; }

        [Required]
        [StringLength(50, ErrorMessage = "National id is too long.")]
